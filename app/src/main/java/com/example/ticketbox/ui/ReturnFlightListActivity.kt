...
class ReturnFlightListActivity : AppCompatActivity() {
    ...
    private var returnFlightList: ListView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        returnFlightList = findViewById<View>(R.id.returnFlightList) as ListView
        btnSort = findViewById<View>(R.id.btnReturnSort) as Button
        ...
        try {
            ...
            if (cursor != null && cursor!!.count > 0) {
                ...
                actionBar!!.setSubtitle(
                    HelperUtilities.capitalize(destination) + " -> " + HelperUtilities.capitalize(
                        origin
                    )
                )
                ...
                returnFlightList!!.adapter = listAdapter
            } else {
                flightNotFoundDialog().show()
            }
            returnFlightList!!.onItemClickListener =
                OnItemClickListener { adapterView, view, position, id ->
                    returnFlightID = id.toInt()
